export default function AboutUs() {
    return (
        <div className="aboutus">
            ...
            <h3>Welcome to ThoughtLane, your digital avenue for ideas, insights, and inspiration!</h3>
            <div className="about-content">We are a vibrant blogging platform dedicated to sharing diverse perspectives on topics that matter—from technology and lifestyle to creativity and personal growth. <br></br> <br></br>
